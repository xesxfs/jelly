package package_9
{
   ...
   public final class class_94 implements class_38
   {
      ...
      public function class_94(param1:BitmapData = null, param2:Number = 0, param3:Number = 0, param4:Number = 1, param5:Number = 1)
      {
         super();
         this.var_322 = param1;
         this.var_729 = param2;
      ...
      public final function invalidate() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_322.width)
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_322.height)
            {
               _loc3_ = uint(this.var_322.getPixel32(_loc1_,_loc2_));
               _loc4_ = (_loc3_ >> 24 & 255) / 255;
               if(_loc4_ != 0)
               {
                  this.var_894.add(new Point(_loc1_,_loc2_),_loc4_);
               }
               _loc2_++;
            }
            _loc1_++;
