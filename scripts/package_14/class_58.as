package package_14
{
   ...
   public final class class_58 extends class_32
   {
      ...
      public function class_58(param1:Number = 0, param2:Number = NaN)
      {
         super();
      ...
      override public function initialize(param1:class_59, param2:class_62) : void
      {
         ...
         {
            _loc3_.rotation = _loc3_.rotation + this.var_469;
         }
         else
         {
            _loc3_.rotation = _loc3_.rotation + (this.var_469 + Math.random() * (this.var_579 - this.var_469));
         }
      }
   }
}
