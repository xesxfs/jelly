package zpp_nape.util
{
   ...
   public final class ZPP_Set_ZPP_CbSet
   {
      
      public static var var_72:ZPP_Set_ZPP_CbSet = null;
       
      
      public var name_9:Function;
      
      public var var_75:ZPP_Set_ZPP_CbSet;
      ...
      public static function successor_node(param1:ZPP_Set_ZPP_CbSet) : ZPP_Set_ZPP_CbSet
      {
      ...
      public static function predecessor_node(param1:ZPP_Set_ZPP_CbSet) : ZPP_Set_ZPP_CbSet
      {
         var _loc2_:* = null as ZPP_Set_ZPP_CbSet;
      ...
      public static function method_237(param1:ZPP_Set_ZPP_CbSet, param2:Function) : ZPP_Set_ZPP_CbSet
      {
         param2(param1.data);
         ...
         _loc4_.lt = null;
         _loc4_.name_9 = null;
         _loc4_.next = ZPP_Set_ZPP_CbSet.var_72;
         ZPP_Set_ZPP_CbSet.var_72 = _loc4_;
         return _loc3_;
      }
      ...
      public final function method_189(param1:ZPP_CbSet) : Boolean
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(parent == null)
         {
            ...
            {
               _loc2_ = ZPP_Set_ZPP_CbSet.var_72;
               ZPP_Set_ZPP_CbSet.var_72 = _loc2_.next;
               _loc2_.next = null;
            }
            null;
            _loc2_.data = param1;
      ...
      public final function method_127(param1:ZPP_CbSet) : ZPP_Set_ZPP_CbSet
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(parent == null)
      ...
      public final function method_217(param1:ZPP_CbSet) : ZPP_CbSet
      {
         ;
         var _loc2_:ZPP_Set_ZPP_CbSet = ZPP_Set_ZPP_CbSet.successor_node(find(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      public final function remove_node(param1:ZPP_Set_ZPP_CbSet) : void
      {
         var _loc2_:* = null as ZPP_Set_ZPP_CbSet;
         var _loc3_:* = null as ZPP_CbSet;
         var _loc4_:* = null as ZPP_Set_ZPP_CbSet;
      ...
      public final function method_243(param1:ZPP_CbSet) : ZPP_CbSet
      {
         ;
         var _loc2_:ZPP_Set_ZPP_CbSet = ZPP_Set_ZPP_CbSet.predecessor_node(find(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      public final function method_208() : ZPP_CbSet
      {
      ...
      public final function method_240(param1:ZPP_CbSet) : ZPP_CbSet
      {
      ...
      public final function insert(param1:ZPP_CbSet) : ZPP_Set_ZPP_CbSet
      {
         var _loc2_:* = null as ZPP_Set_ZPP_CbSet;
         var _loc3_:* = null as ZPP_Set_ZPP_CbSet;
         if(ZPP_Set_ZPP_CbSet.var_72 == null)
      ...
      public final function method_218(param1:ZPP_CbSet) : Boolean
      {
         return find_weak(param1) != null;
      }
      
      public final function has(param1:ZPP_CbSet) : Boolean
      {
         return find(param1) != null;
      }
      
      public final function name_41() : ZPP_CbSet
      {
         var _loc1_:ZPP_Set_ZPP_CbSet = parent;
         while(_loc1_.var_75 != null)
         {
      ...
      public final function find_weak(param1:ZPP_CbSet) : ZPP_Set_ZPP_CbSet
      {
      ...
      public final function find(param1:ZPP_CbSet) : ZPP_Set_ZPP_CbSet
      {
         var _loc2_:ZPP_Set_ZPP_CbSet = parent;
         ...
         else
         {
            ...
            while(_loc1_ != null)
            {
               ...
               else
               {
                  ...
                  _loc3_.lt = null;
                  _loc3_.name_9 = null;
                  _loc3_.next = ZPP_Set_ZPP_CbSet.var_72;
                  ZPP_Set_ZPP_CbSet.var_72 = _loc3_;
                  _loc1_ = _loc2_;
               }
            }
            parent = null;
      ...
      public final function __fix_neg_red(param1:ZPP_Set_ZPP_CbSet) : void
      {
         var _loc3_:* = null as ZPP_Set_ZPP_CbSet;
         var _loc4_:* = null as ZPP_Set_ZPP_CbSet;
         var _loc5_:* = null as ZPP_Set_ZPP_CbSet;
      ...
      public final function __fix_dbl_red(param1:ZPP_Set_ZPP_CbSet) : void
      {
         var _loc2_:* = null as ZPP_Set_ZPP_CbSet;
         var _loc3_:* = null as ZPP_Set_ZPP_CbSet;
         var _loc4_:* = null as ZPP_Set_ZPP_CbSet;
