package package_7
{
   ...
   public final class class_152 extends class_29
   {
      ...
      public function class_152(param1:Number = 0, param2:Number = 0)
      {
         super();
         priority = 10;
         this.method_511 = param1;
         this.method_168 = param2;
      }
      
      public function get method_511() : Number
      {
         return this.var_469;
      }
      
      public function set method_511(param1:Number) : void
      {
         this.var_469 = param1;
         this.var_1052 = param1 * param1;
      }
      ...
      override public function update(param1:class_59, param2:class_62, param3:Number) : void
      {
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc17_ > this.var_469)
            {
               break;
            }
            _loc13_ = Number(_loc4_.y - _loc7_.y);
            if(!(Number(_loc4_.y - _loc7_.y) > this.var_469 || _loc13_ < -this.var_469))
            {
               _loc11_ = Number(_loc13_ * _loc13_ + _loc12_ * _loc12_);
               if(Number(_loc13_ * _loc13_ + _loc12_ * _loc12_) <= this.var_1052 && _loc11_ > 0)
               {
