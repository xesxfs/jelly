package package_7
{
   ...
   public final class class_156 extends class_29
   {
      ...
      public function class_156(param1:Number = 0, param2:Number = 0)
      {
         super();
         priority = 10;
      ...
      override public function update(param1:class_59, param2:class_62, param3:Number) : void
      {
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(!(Number(_loc7_.y - _loc4_.y) > this.var_579 || _loc12_ < -this.var_579))
            {
               ...
               {
                  _loc13_ = Number(_loc13_ + _loc7_.var_119);
                  _loc14_ = Number(_loc14_ + _loc7_.var_118);
                  _loc15_++;
               }
            }
            _loc8_--;
         ...
         if(_loc15_ != 0)
         {
            _loc13_ = Number(_loc13_ / _loc15_ - _loc4_.var_119);
            _loc14_ = Number(_loc14_ / _loc15_ - _loc4_.var_118);
            if(_loc13_ != 0 || _loc14_ != 0)
            {
               _loc16_ = Number(param3 * this.var_1034 / Math.sqrt(_loc13_ * _loc13_ + _loc14_ * _loc14_));
               if(_loc16_ > 1)
               {
                  _loc16_ = 1;
               }
               _loc4_.var_119 = _loc4_.var_119 + _loc16_ * _loc13_;
               _loc4_.var_118 = _loc4_.var_118 + _loc16_ * _loc14_;
            }
         }
      }
   }
