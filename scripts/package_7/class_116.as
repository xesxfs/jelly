package package_7
{
   ...
   public final class class_116 extends class_29
   {
      ...
      public function class_116(param1:Number = 0, param2:DisplayObject = null)
      {
         super();
         this.power = param1;
      ...
      override public function update(param1:class_59, param2:class_62, param3:Number) : void
      {
         ...
         if(_loc8_)
         {
            _loc9_ = this.var_630.mouseX - _loc4_.x;
            _loc10_ = this.var_630.mouseY - _loc4_.y;
