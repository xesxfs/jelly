package package_7
{
   ...
   public final class TweenToZone extends class_29 implements class_31
   {
       
      
      private var var_898:class_38;
      
      public function TweenToZone(param1:class_38)
      {
         super();
         this.var_898 = param1;
         priority = -10;
      ...
      public function initialize(param1:class_59, param2:class_62) : void
      {
         ...
         _loc3_.method_151["[object TweenToZone]"] = _loc5_;
      }
      ...
      override public function update(param1:class_59, param2:class_62, param3:Number) : void
      {
         ...
         if(!_loc4_.method_151["[object TweenToZone]"])
         {
            this.initialize(param1,param2);
         }
         _loc5_ = _loc4_.method_151["[object TweenToZone]"];
...
class TweenToZoneData
{
   ...
   function TweenToZoneData(param1:Number, param2:Number, param3:Number, param4:Number)
   {
      super();
