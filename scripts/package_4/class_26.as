package package_4
{
   ...
   public final class class_26 extends class_25
   {
      ...
      public function class_26(param1:Rectangle = null, param2:Boolean = false)
      {
         super(param1,param2);
         var_758 = false;
      ...
      override protected function method_672(param1:Particle2D) : void
      {
         ...
         this.var_774.graphics.moveTo(param1.var_243,param1.var_248);
         this.var_774.graphics.lineTo(param1.x,param1.y);
