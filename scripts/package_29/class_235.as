package package_29
{
   ...
   public final class class_235
   {
      ...
      public static function method_143(param1:Array) : class_235
      {
         var _loc4_:* = null as Compound;
         var _loc2_:class_235 = new class_235();
         var _loc3_:int = 0;
      ...
      public static function method_147(param1:Vector.<Compound>) : class_235
      {
         var _loc4_:* = null as Compound;
         var _loc2_:class_235 = new class_235();
         var _loc3_:int = 0;
      ...
      public final function unshift(param1:Compound) : Boolean
      {
         var _loc2_:Boolean = false;
         zpp_inner;
         ZPP_CompoundList.method_107();
      ...
      public final function toString() : String
      {
         var _loc4_:* = null as Compound;
         var _loc5_:int = 0;
         var _loc6_:* = null as class_235;
         zpp_inner.method_104();
         var _loc3_:class_229 = class_229.method_65(this);
         ...
         {
            _loc3_.var_106 = class_229.var_72;
            class_229.var_72 = _loc3_;
      ...
      public final function shift() : Compound
      {
      ...
      public final function remove(param1:Compound) : Boolean
      {
         ...
         zpp_inner.method_104();
         var _loc2_:Boolean = false;
         var _loc3_:ZNPNode_ZPP_Compound = zpp_inner.name_4.var_73;
         while(_loc3_ != null)
         {
      ...
      public final function push(param1:Compound) : Boolean
      {
         var _loc2_:Boolean = false;
         zpp_inner;
         ZPP_CompoundList.method_107();
      ...
      public final function pop() : Compound
      {
      ...
      public final function method_150(param1:class_235) : void
      {
         var _loc3_:* = null as Compound;
         var _loc4_:int = 0;
         var _loc5_:* = null as class_235;
         param1.zpp_inner.method_104();
         var _loc2_:class_229 = class_229.method_65(param1);
      ...
      public final function iterator() : class_229
      {
         zpp_inner.method_104();
         return class_229.method_65(this);
      }
      
      public final function has(param1:Compound) : Boolean
      {
         zpp_inner.method_104();
      ...
      public final function method_145(param1:Function) : class_235
      {
         var _loc4_:int = 0;
         var _loc6_:* = null as class_235;
         zpp_inner.method_104();
      ...
      public final function filter(param1:Function) : class_235
      {
         var _loc4_:* = null as Compound;
         var _loc3_:int = 0;
      }
      ...
      public final function copy(param1:Boolean = false) : class_235
      {
         var _loc4_:* = null as Compound;
         var _loc5_:int = 0;
         var _loc6_:* = null as class_235;
      ...
      public final function at(param1:int) : Compound
      {
         zpp_inner.method_104();
         if(zpp_inner.var_111)
         {
      ...
      public final function add(param1:Compound) : Boolean
      {
         if(zpp_inner.var_111)
         {
