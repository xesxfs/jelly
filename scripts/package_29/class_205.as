package package_29
{
   ...
   public final class class_205
   {
      ...
      public static function method_143(param1:Array) : class_205
      {
         var _loc4_:* = null as Body;
         var _loc2_:class_205 = new class_205();
         var _loc3_:int = 0;
      ...
      public static function method_147(param1:Vector.<Body>) : class_205
      {
         var _loc4_:* = null as Body;
         var _loc2_:class_205 = new class_205();
         var _loc3_:int = 0;
      ...
      public final function unshift(param1:Body) : Boolean
      {
         var _loc2_:Boolean = false;
         zpp_inner;
         ZPP_BodyList.method_107();
      ...
      public final function toString() : String
      {
         ...
         zpp_inner.method_104();
         var _loc3_:class_231 = class_231.method_65(this);
         ...
         {
            _loc3_.var_106 = class_231.var_72;
      ...
      public final function shift() : Body
      {
      ...
      public final function remove(param1:Body) : Boolean
      {
         ...
         zpp_inner.method_104();
         var _loc2_:Boolean = false;
         var _loc3_:ZNPNode_ZPP_Body = zpp_inner.name_4.var_73;
         while(_loc3_ != null)
         {
      ...
      public final function push(param1:Body) : Boolean
      {
         var _loc2_:Boolean = false;
         zpp_inner;
         ZPP_BodyList.method_107();
      ...
      public final function pop() : Body
      {
      ...
      public final function method_150(param1:class_205) : void
      {
         var _loc3_:* = null as Body;
         var _loc4_:int = 0;
         var _loc5_:* = null as class_205;
         param1.zpp_inner.method_104();
         var _loc2_:class_231 = class_231.method_65(param1);
      ...
      public final function iterator() : class_231
      {
         zpp_inner.method_104();
         return class_231.method_65(this);
      }
      
      public final function has(param1:Body) : Boolean
      {
         zpp_inner.method_104();
      ...
      public final function method_145(param1:Function) : class_205
      {
         var _loc4_:int = 0;
         var _loc6_:* = null as class_205;
         zpp_inner.method_104();
      ...
      public final function filter(param1:Function) : class_205
      {
         var _loc4_:* = null as Body;
         var _loc3_:int = 0;
      }
      ...
      public final function copy(param1:Boolean = false) : class_205
      {
         var _loc4_:* = null as Body;
         var _loc5_:int = 0;
         var _loc6_:* = null as class_205;
      ...
      public final function at(param1:int) : Body
      {
         zpp_inner.method_104();
         if(zpp_inner.var_111)
         {
      ...
      public final function add(param1:Body) : Boolean
      {
         if(zpp_inner.var_111)
         {
