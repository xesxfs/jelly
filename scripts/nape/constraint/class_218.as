package nape.constraint
{
   ...
   public final class class_218
   {
      ...
      public static function method_143(param1:Array) : class_218
      {
         var _loc4_:* = null as Constraint;
         var _loc2_:class_218 = new class_218();
         var _loc3_:int = 0;
      ...
      public static function method_147(param1:Vector.<Constraint>) : class_218
      {
         var _loc4_:* = null as Constraint;
         var _loc2_:class_218 = new class_218();
         var _loc3_:int = 0;
      ...
      public final function unshift(param1:Constraint) : Boolean
      {
         var _loc2_:Boolean = false;
         zpp_inner;
         ZPP_ConstraintList.method_107();
      ...
      public final function toString() : String
      {
         var _loc4_:* = null as Constraint;
         var _loc5_:int = 0;
         var _loc6_:* = null as class_218;
         zpp_inner.method_104();
         var _loc3_:class_234 = class_234.method_65(this);
         ...
         {
            _loc3_.var_106 = class_234.var_72;
            class_234.var_72 = _loc3_;
      ...
      public final function shift() : Constraint
      {
      ...
      public final function remove(param1:Constraint) : Boolean
      {
         ...
         zpp_inner.method_104();
         var _loc2_:Boolean = false;
         var _loc3_:ZNPNode_ZPP_Constraint = zpp_inner.name_4.var_73;
         while(_loc3_ != null)
         {
      ...
      public final function push(param1:Constraint) : Boolean
      {
         var _loc2_:Boolean = false;
         zpp_inner;
         ZPP_ConstraintList.method_107();
      ...
      public final function pop() : Constraint
      {
      ...
      public final function method_150(param1:class_218) : void
      {
         var _loc3_:* = null as Constraint;
         var _loc4_:int = 0;
         var _loc5_:* = null as class_218;
         param1.zpp_inner.method_104();
         var _loc2_:class_234 = class_234.method_65(param1);
      ...
      public final function iterator() : class_234
      {
         zpp_inner.method_104();
         return class_234.method_65(this);
      }
      
      public final function has(param1:Constraint) : Boolean
      {
         zpp_inner.method_104();
      ...
      public final function method_145(param1:Function) : class_218
      {
         var _loc4_:int = 0;
         var _loc6_:* = null as class_218;
         zpp_inner.method_104();
      ...
      public final function filter(param1:Function) : class_218
      {
         var _loc4_:* = null as Constraint;
         var _loc3_:int = 0;
      }
      ...
      public final function copy(param1:Boolean = false) : class_218
      {
         var _loc4_:* = null as Constraint;
         var _loc5_:int = 0;
         var _loc6_:* = null as class_218;
      ...
      public final function at(param1:int) : Constraint
      {
         zpp_inner.method_104();
         if(zpp_inner.var_111)
         {
      ...
      public final function add(param1:Constraint) : Boolean
      {
         if(zpp_inner.var_111)
         {
