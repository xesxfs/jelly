package nape.geom
{
   ...
   public final class class_321
   {
      ...
      public static function method_143(param1:Array) : class_321
      {
         var _loc4_:* = null as class_260;
         var _loc2_:class_321 = new class_321();
         var _loc3_:int = 0;
      ...
      public static function method_147(param1:Vector.<class_260>) : class_321
      {
         var _loc4_:* = null as class_260;
         var _loc2_:class_321 = new class_321();
         var _loc3_:int = 0;
      ...
      public final function unshift(param1:class_260) : Boolean
      {
         var _loc2_:Boolean = false;
         zpp_inner;
         ZPP_GeomPolyList.method_107();
      ...
      public final function toString() : String
      {
         var _loc4_:* = null as class_260;
         var _loc5_:int = 0;
         var _loc6_:* = null as class_321;
         zpp_inner.method_104();
         var _loc3_:class_271 = class_271.method_65(this);
         ...
         {
            _loc3_.var_106 = class_271.var_72;
            class_271.var_72 = _loc3_;
      ...
      public final function remove(param1:class_260) : Boolean
      {
         ...
         zpp_inner.method_104();
         var _loc2_:Boolean = false;
         var _loc3_:ZNPNode_ZPP_GeomPoly = zpp_inner.name_4.var_73;
         while(_loc3_ != null)
         {
      ...
      public final function push(param1:class_260) : Boolean
      {
         var _loc2_:Boolean = false;
         zpp_inner;
         ZPP_GeomPolyList.method_107();
      ...
      public final function method_150(param1:class_321) : void
      {
         var _loc3_:* = null as class_260;
         var _loc4_:int = 0;
         var _loc5_:* = null as class_321;
         param1.zpp_inner.method_104();
         var _loc2_:class_271 = class_271.method_65(param1);
         ...
         {
            _loc2_.var_106 = class_271.var_72;
            class_271.var_72 = _loc2_;
            _loc2_.zpp_inner = null;
            §§push(false);
         }
      }
      
      public final function iterator() : class_271
      {
         zpp_inner.method_104();
         return class_271.method_65(this);
      }
      
      public final function has(param1:class_260) : Boolean
      {
         zpp_inner.method_104();
      ...
      public final function method_145(param1:Function) : class_321
      {
         var _loc4_:int = 0;
         var _loc6_:* = null as class_321;
         zpp_inner.method_104();
      ...
      public final function filter(param1:Function) : class_321
      {
         var _loc4_:* = null as class_260;
         var _loc3_:int = 0;
      }
      ...
      public final function copy(param1:Boolean = false) : class_321
      {
         var _loc4_:* = null as class_260;
         var _loc5_:int = 0;
         var _loc6_:* = null as class_321;
      ...
      public final function at(param1:int) : class_260
      {
         zpp_inner.method_104();
         if(zpp_inner.var_111)
         {
      ...
      public final function add(param1:class_260) : Boolean
      {
         if(zpp_inner.var_111)
         {
