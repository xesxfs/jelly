package nape.geom
{
   ...
   public final class class_236
   {
      ...
      public static function method_143(param1:Array) : class_236
      {
         var _loc4_:* = null as ConvexResult;
         var _loc2_:class_236 = new class_236();
         var _loc3_:int = 0;
      ...
      public static function method_147(param1:Vector.<ConvexResult>) : class_236
      {
         var _loc4_:* = null as ConvexResult;
         var _loc2_:class_236 = new class_236();
         var _loc3_:int = 0;
      ...
      public final function unshift(param1:ConvexResult) : Boolean
      {
         var _loc2_:Boolean = false;
         zpp_inner;
         ZPP_ConvexResultList.method_107();
      ...
      public final function toString() : String
      {
         var _loc4_:* = null as ConvexResult;
         var _loc5_:int = 0;
         var _loc6_:* = null as class_236;
         zpp_inner.method_104();
         var _loc3_:class_268 = class_268.method_65(this);
         ...
         {
            _loc3_.var_106 = class_268.var_72;
            class_268.var_72 = _loc3_;
      ...
      public final function shift() : ConvexResult
      {
      ...
      public final function remove(param1:ConvexResult) : Boolean
      {
         var _loc4_:* = null as ConvexResult;
         zpp_inner;
         ZPP_ConvexResultList.method_107();
         zpp_inner.method_104();
         var _loc2_:Boolean = false;
         var _loc3_:ZNPNode_ConvexResult = zpp_inner.name_4.var_73;
         while(_loc3_ != null)
         {
      ...
      public final function push(param1:ConvexResult) : Boolean
      {
         var _loc2_:Boolean = false;
         zpp_inner;
         ZPP_ConvexResultList.method_107();
      ...
      public final function pop() : ConvexResult
      {
      ...
      public final function method_150(param1:class_236) : void
      {
         var _loc3_:* = null as ConvexResult;
         var _loc4_:int = 0;
         var _loc5_:* = null as class_236;
         param1.zpp_inner.method_104();
         var _loc2_:class_268 = class_268.method_65(param1);
         ...
         {
            _loc2_.var_106 = class_268.var_72;
            class_268.var_72 = _loc2_;
            _loc2_.zpp_inner = null;
            §§push(false);
         }
      }
      
      public final function iterator() : class_268
      {
         zpp_inner.method_104();
         return class_268.method_65(this);
      }
      ...
      public final function method_145(param1:Function) : class_236
      {
         var _loc4_:int = 0;
         var _loc6_:* = null as class_236;
         zpp_inner.method_104();
      ...
      public final function filter(param1:Function) : class_236
      {
         var _loc4_:* = null as ConvexResult;
         var _loc3_:int = 0;
      }
      ...
      public final function copy(param1:Boolean = false) : class_236
      {
         var _loc4_:* = null as ConvexResult;
         var _loc5_:int = 0;
         var _loc6_:* = null as class_236;
      ...
      public final function add(param1:ConvexResult) : Boolean
      {
         if(zpp_inner.var_111)
         {
