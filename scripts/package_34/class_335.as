package package_34
{
   ...
   public final class class_335 extends class_247
   {
       
      
      public var var_85:ZPP_ConstraintListener;
      
      public function class_335(param1:class_249, param2:*, param3:Function, param4:int = 0)
      {
         var_85 = null;
         super();
         var _loc5_:int = -1;
         ...
         else
         {
            ...
            else
            {
               ...
               {
                  _loc5_ = class_223.var_860;
               }
            }
         }
         var_85 = new ZPP_ConstraintListener(ZPP_OptionType.argument(param2),_loc5_,param3);
         zpp_inner = var_85;
