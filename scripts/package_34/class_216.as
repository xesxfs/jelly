package package_34
{
   ...
   public final class class_216
   {
      ...
      public static function method_143(param1:Array) : class_216
      {
         var _loc4_:* = null as class_250;
      ...
      public static function method_147(param1:Vector.<class_250>) : class_216
      {
         var _loc4_:* = null as class_250;
         var _loc2_:class_216 = new class_216();
         var _loc3_:int = 0;
      ...
      public final function unshift(param1:class_250) : Boolean
      {
         var _loc2_:Boolean = false;
         zpp_inner;
         ZPP_CbTypeList.method_107();
      ...
      public final function toString() : String
      {
         var _loc4_:* = null as class_250;
         var _loc5_:int = 0;
         var _loc6_:* = null as class_216;
         zpp_inner.method_104();
         var _loc3_:class_264 = class_264.method_65(this);
      ...
      public final function shift() : class_250
      {
      ...
      public final function remove(param1:class_250) : Boolean
      {
         ...
         zpp_inner.method_104();
         var _loc2_:Boolean = false;
         var _loc3_:ZNPNode_ZPP_CbType = zpp_inner.name_4.var_73;
         while(_loc3_ != null)
         {
      ...
      public final function push(param1:class_250) : Boolean
      {
         var _loc2_:Boolean = false;
         zpp_inner;
         ZPP_CbTypeList.method_107();
      ...
      public final function pop() : class_250
      {
         var _loc2_:* = null as class_250;
      ...
      public final function method_150(param1:class_216) : void
      {
         var _loc3_:* = null as class_250;
         var _loc4_:int = 0;
         var _loc5_:* = null as class_216;
         param1.zpp_inner.method_104();
         var _loc2_:class_264 = class_264.method_65(param1);
      ...
      public final function iterator() : class_264
      {
         zpp_inner.method_104();
         return class_264.method_65(this);
      }
      
      public final function has(param1:class_250) : Boolean
      {
         zpp_inner.method_104();
      ...
      public final function method_145(param1:Function) : class_216
      {
         var _loc4_:int = 0;
         var _loc6_:* = null as class_216;
         zpp_inner.method_104();
      ...
      public final function filter(param1:Function) : class_216
      {
         var _loc4_:* = null as class_250;
         var _loc3_:int = 0;
      }
      ...
      public final function copy(param1:Boolean = false) : class_216
      {
         var _loc4_:* = null as class_250;
         var _loc5_:int = 0;
         var _loc6_:* = null as class_216;
      ...
      public final function at(param1:int) : class_250
      {
         zpp_inner.method_104();
         if(zpp_inner.var_111)
         {
      ...
      public final function add(param1:class_250) : Boolean
      {
         if(zpp_inner.var_111)
         {
