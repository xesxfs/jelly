package package_34
{
   ...
   public final class class_224
   {
      ...
      public static function method_143(param1:Array) : class_224
      {
         var _loc4_:* = null as class_247;
         var _loc2_:class_224 = new class_224();
         var _loc3_:int = 0;
      ...
      public static function method_147(param1:Vector.<class_247>) : class_224
      {
         var _loc4_:* = null as class_247;
         var _loc2_:class_224 = new class_224();
         var _loc3_:int = 0;
      ...
      public final function unshift(param1:class_247) : Boolean
      {
         var _loc2_:Boolean = false;
         zpp_inner;
         ZPP_ListenerList.method_107();
      ...
      public final function toString() : String
      {
         var _loc4_:* = null as class_247;
         var _loc5_:int = 0;
         var _loc6_:* = null as class_224;
         zpp_inner.method_104();
         var _loc3_:class_261 = class_261.method_65(this);
         ...
         {
            _loc3_.var_106 = class_261.var_72;
            class_261.var_72 = _loc3_;
      ...
      public final function shift() : class_247
      {
         var _loc2_:* = null as ZNPNode_ZPP_Listener;
         var _loc3_:* = null as class_247;
         zpp_inner;
         ZPP_ListenerList.method_107();
         zpp_inner.method_104();
         var _loc1_:* = null;
      ...
      public final function remove(param1:class_247) : Boolean
      {
         ...
         zpp_inner.method_104();
         var _loc2_:Boolean = false;
         var _loc3_:ZNPNode_ZPP_Listener = zpp_inner.name_4.var_73;
         while(_loc3_ != null)
         {
      ...
      public final function push(param1:class_247) : Boolean
      {
         var _loc2_:Boolean = false;
         zpp_inner;
         ZPP_ListenerList.method_107();
      ...
      public final function pop() : class_247
      {
         var _loc2_:* = null as class_247;
      ...
      public final function method_150(param1:class_224) : void
      {
         var _loc3_:* = null as class_247;
         var _loc4_:int = 0;
         var _loc5_:* = null as class_224;
         param1.zpp_inner.method_104();
         var _loc2_:class_261 = class_261.method_65(param1);
         ...
         {
            _loc2_.var_106 = class_261.var_72;
            class_261.var_72 = _loc2_;
            _loc2_.zpp_inner = null;
            §§push(false);
         }
      }
      
      public final function iterator() : class_261
      {
         zpp_inner.method_104();
         return class_261.method_65(this);
      }
      
      public final function has(param1:class_247) : Boolean
      {
         zpp_inner.method_104();
      ...
      public final function method_145(param1:Function) : class_224
      {
         var _loc4_:int = 0;
         var _loc6_:* = null as class_224;
         zpp_inner.method_104();
      ...
      public final function filter(param1:Function) : class_224
      {
         var _loc4_:* = null as class_247;
         var _loc3_:int = 0;
      }
      ...
      public final function copy(param1:Boolean = false) : class_224
      {
         var _loc4_:* = null as class_247;
         var _loc5_:int = 0;
         var _loc6_:* = null as class_224;
      ...
      public final function at(param1:int) : class_247
      {
         zpp_inner.method_104();
         if(zpp_inner.var_111)
         {
      ...
      public final function add(param1:class_247) : Boolean
      {
         if(zpp_inner.var_111)
         {
