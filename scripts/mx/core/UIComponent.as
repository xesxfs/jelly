package mx.core
{
   ...
   public class UIComponent extends FlexSprite implements IAutomationObject, IChildList, IConstraintClient, IDeferredInstantiationUIComponent, IFlexDisplayObject, IFlexModule, IInvalidating, ILayoutManagerClient, IPropertyChangeNotifier, IRepeaterClient, IStateClient, IAdvancedStyleClient, IToolTipManagerClient, IUIComponent, IValidatorListener, IVisualElement
   {
      ...
      mx_internal final function get method_574() : Number
      {
         return super.scaleX;
      }
      
      mx_internal final function set method_574(param1:Number) : void
      {
         super.scaleX = param1;
      }
      
      mx_internal final function get method_691() : Number
      {
         return super.scaleY;
      }
      
      mx_internal final function set method_691(param1:Number) : void
      {
         super.scaleY = param1;
      }
      ...
      public function setVisible(param1:Boolean, param2:Boolean = false) : void
      {
         ...
         if(this.method_207 == param1)
         {
            return;
         }
         this.method_207 = param1;
         if(!param2)
         {
      ...
      public function set designLayer(param1:DesignLayer) : void
      {
         ...
         this.method_297 = !!this._designLayer?Number(this._alpha * this._designLayer.effectiveAlpha):Number(this._alpha);
         this.method_207 = !!this.designLayer?this._visible && this._designLayer.effectiveVisibility:Boolean(this._visible);
      }
      
      mx_internal final function get method_297() : Number
      {
         return super.alpha;
      }
      
      mx_internal final function set method_297(param1:Number) : void
      {
         super.alpha = param1;
      }
      
      mx_internal final function get method_406() : String
      {
         return super.blendMode;
      }
      
      mx_internal final function set method_406(param1:String) : void
      {
         super.blendMode = param1;
      }
      
      mx_internal final function set method_194(param1:Shader) : void
      {
         super.blendShader = param1;
      }
      
      mx_internal final function get method_318() : DisplayObjectContainer
      {
         return super.parent;
      }
      
      mx_internal final function get method_700() : Number
      {
         return super.x;
      }
      
      mx_internal final function set method_700(param1:Number) : void
      {
         super.x = param1;
      }
      
      mx_internal final function get method_663() : Number
      {
         return super.y;
      }
      
      mx_internal final function set method_663(param1:Number) : void
      {
         super.y = param1;
      }
      
      mx_internal final function get method_559() : Number
      {
         return super.width;
      }
      
      mx_internal final function set method_559(param1:Number) : void
      {
         super.width = param1;
      }
      
      mx_internal final function get method_609() : Number
      {
         return super.height;
      }
      
      mx_internal final function set method_609(param1:Number) : void
      {
         super.height = param1;
      }
      
      mx_internal final function get method_207() : Boolean
      {
         return super.visible;
      }
      
      mx_internal final function set method_207(param1:Boolean) : void
      {
      ...
      public function set moduleFactory(param1:IFlexModuleFactory) : void
      {
         ...
         if(this.advanceStyleClientChildren != null)
         {
            for(_loc5_ in this.advanceStyleClientChildren)
            {
               ...
               if(_loc6_ && (_loc6_.moduleFactory == null || _loc6_.moduleFactory == this._moduleFactory))
               {
      ...
      mx_internal final function method_871(param1:DisplayObject) : DisplayObject
      {
         return super.addChild(param1);
      }
      
      mx_internal final function method_376(param1:DisplayObject, param2:int) : DisplayObject
      {
         return super.addChildAt(param1,param2);
      }
      
      mx_internal final function method_430(param1:DisplayObject) : DisplayObject
      {
         return super.removeChild(param1);
      }
      
      mx_internal final function method_615(param1:int) : DisplayObject
      {
         return super.removeChildAt(param1);
      }
      
      mx_internal final function method_899(param1:DisplayObject, param2:int) : void
      {
         super.setChildIndex(param1,param2);
      }
         ...
         if(this.oldLayoutDirection != this.layoutDirection)
         {
            if(this is IVisualElementContainer)
            {
               ...
               while(_loc4_ < _loc6_)
               {
                  ...
                  if(_loc7_ && !(_loc7_ is IStyleClient))
                  {
      ...
      protected function commitProperties() : void
      {
         ...
         if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0)
         {
            if(this._scaleX != this.oldScaleX)
            {
               ...
               if(!isNaN(this.explicitMinWidth))
               {
                  this.explicitMinWidth = this.explicitMinWidth * _loc1_;
               }
               if(!isNaN(this.explicitWidth))
               {
                  this.explicitWidth = this.explicitWidth * _loc1_;
               }
               if(!isNaN(this.explicitMaxWidth))
               {
                  this.explicitMaxWidth = this.explicitMaxWidth * _loc1_;
               }
               this._width = this._width * _loc1_;
            ...
            if(this._scaleY != this.oldScaleY)
            {
               ...
               if(!isNaN(this.explicitMinHeight))
               {
                  this.explicitMinHeight = this.explicitMinHeight * _loc2_;
               }
               if(!isNaN(this.explicitHeight))
               {
                  this.explicitHeight = this.explicitHeight * _loc2_;
               }
               if(!isNaN(this.explicitMaxHeight))
               {
                  this.explicitMaxHeight = this.explicitMaxHeight * _loc2_;
               }
               this._height = this._height * _loc2_;
         ...
         if(this.blendModeChanged)
         {
            ...
            {
               this.method_406 = this._blendMode;
            }
            else
            {
               this.blendShaderChanged = false;
               this.method_406 = BlendMode.NORMAL;
               switch(this._blendMode)
               {
                  case "color":
                     this.method_194 = new ColorShader();
                     break;
                  case "colordodge":
                     this.method_194 = new ColorDodgeShader();
                     break;
                  case "colorburn":
                     this.method_194 = new ColorBurnShader();
                     break;
                  case "exclusion":
                     this.method_194 = new ExclusionShader();
                     break;
                  case "hue":
                     this.method_194 = new HueShader();
                     break;
                  case "luminosity":
                     this.method_194 = new LuminosityShader();
                     break;
                  case "saturation":
                     this.method_194 = new SaturationShader();
                     break;
                  case "softlight":
                     this.method_194 = new SoftLightShader();
               }
            }
         }
      ...
      mx_internal function measureSizes() : Boolean
      {
         ...
         else
         {
            ...
            if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0)
            {
               if(_loc4_ != 1)
               {
                  this._measuredMinWidth = this._measuredMinWidth / _loc4_;
                  this._measuredWidth = this._measuredWidth / _loc4_;
               }
               if(_loc5_ != 1)
               {
                  this._measuredMinHeight = this._measuredMinHeight / _loc5_;
                  this._measuredHeight = this._measuredHeight / _loc5_;
               }
            }
            this.measure();
            this.invalidateSizeFlag = false;
      ...
      mx_internal function adjustSizesForScaleChanges() : void
      {
         ...
         if(_loc1_ != this.oldScaleX)
         {
            if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0)
            {
               ...
               {
                  this.explicitMinWidth = this.explicitMinWidth * _loc3_;
               }
               if(!isNaN(this.explicitWidth))
               {
                  this.explicitWidth = this.explicitWidth * _loc3_;
               }
               if(this.explicitMaxWidth)
               {
                  this.explicitMaxWidth = this.explicitMaxWidth * _loc3_;
               }
            }
         ...
         if(_loc2_ != this.oldScaleY)
         {
            if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0)
            {
               ...
               {
                  this.explicitMinHeight = this.explicitMinHeight * _loc3_;
               }
               if(this.explicitHeight)
               {
                  this.explicitHeight = this.explicitHeight * _loc3_;
               }
               if(this.explicitMaxHeight)
               {
                  this.explicitMaxHeight = this.explicitMaxHeight * _loc3_;
               }
            }
      ...
      mx_internal function setUnscaledWidth(param1:Number) : void
      {
         ...
         if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0)
         {
            _loc2_ = _loc2_ * Math.abs(this.oldScaleX);
         }
      ...
      mx_internal function setUnscaledHeight(param1:Number) : void
      {
         ...
         if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0)
         {
            _loc2_ = _loc2_ * Math.abs(this.oldScaleY);
         }
      ...
      protected function adjustFocusRect(param1:DisplayObject = null) : void
      {
         ...
         var _loc5_:IFlexDisplayObject = IFlexDisplayObject(this.getFocusObject());
         if(_loc5_)
         {
            ...
            {
               _loc9_.x = _loc9_.x + this.x;
               _loc9_.y = _loc9_.y + this.y;
            }
            if(param1 != this)
            {
               if(this._layoutFeatures && this._layoutFeatures.mirror)
               {
                  _loc9_.x = _loc9_.x + (this.width - param1.width);
               }
            }
      ...
      private function getTotalDuration(param1:IEffect) : Number
      {
         ...
         _loc2_ = Number(_loc2_ * _loc5_ + _loc4_ * (_loc5_ - 1) + _loc6_);
         return _loc2_;
      }
      ...
      private function getTransition(param1:String, param2:String) : Transition
      {
         ...
         while(_loc5_ < this.transitions.length)
         {
            ...
            if(_loc6_.fromState == "package_3" && _loc6_.toState == "package_3" && _loc4_ < 1)
            {
               _loc3_ = _loc6_;
               _loc4_ = 1;
            }
            else if(_loc6_.toState == param1 && _loc6_.fromState == "package_3" && _loc6_.autoReverse && _loc4_ < 2)
            {
               _loc3_ = _loc6_;
               _loc4_ = 2;
            }
            else if(_loc6_.toState == "package_3" && _loc6_.fromState == param2 && _loc6_.autoReverse && _loc4_ < 3)
            {
               _loc3_ = _loc6_;
               _loc4_ = 3;
            }
            ...
            else if(_loc6_.fromState == param1 && _loc6_.toState == "package_3" && _loc4_ < 5)
            {
               _loc3_ = _loc6_;
               _loc4_ = 5;
            }
            else if(_loc6_.fromState == "package_3" && _loc6_.toState == param2 && _loc4_ < 6)
            {
               _loc3_ = _loc6_;
               _loc4_ = 6;
            }
      ...
      public function regenerateStyleCache(param1:Boolean) : void
      {
         ...
         if(this.advanceStyleClientChildren != null)
         {
            for(_loc6_ in this.advanceStyleClientChildren)
            {
               ...
               if(_loc7_ && _loc7_.inheritingStyles != StyleProtoChain.STYLE_UNINITIALIZED)
               {
      ...
      mx_internal function addOverlay(param1:uint, param2:RoundedRectangle = null) : void
      {
         if(!this.effectOverlay)
         {
            ...
            this.effectOverlay.method_207 = true;
      ...
      mx_internal function removeOverlay() : void
      {
         if(this.effectOverlayReferenceCount > 0 && --this.effectOverlayReferenceCount == 0 && this.effectOverlay)
         {
            ...
            {
               this.method_430(this.effectOverlay);
            }
      ...
      private function processEffectFinished(param1:Array) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            ...
            while(_loc3_ < param1.length)
            {
               ...
               if(_loc4_ == this._effectsStarted[_loc2_])
               {
      ...
      protected function layer_PropertyChange(param1:PropertyChangeEvent) : void
      {
         ...
         switch(param1.property)
         {
            case "effectiveVisibility":
               ...
               if(_loc2_ != this.method_207)
               {
                  this.method_207 = _loc2_;
                  break;
               }
               break;
            case "effectiveAlpha":
               _loc3_ = Number(param1.newValue) * this._alpha;
               if(_loc3_ != this.method_297)
               {
                  this.method_297 = _loc3_;
                  break;
               }
         }
      }
      ...
      mx_internal function getFontContext(param1:String, param2:Boolean, param3:Boolean, param4:* = undefined) : IFlexModuleFactory
      {
         ...
         var _loc5_:IEmbeddedFontRegistry = embeddedFontRegistry;
      ...
      public function hasFontContextChanged() : Boolean
      {
         ...
         return (!!noEmbeddedFonts?null:embeddedFontRegistry.getAssociatedModuleFactory(_loc1_,_loc4_,_loc5_,this,this.moduleFactory,this.systemManager)) != this.oldEmbeddedFontContext;
      }
      ...
      public function getVisibleRect(param1:DisplayObject = null) : Rectangle
      {
         ...
         var _loc2_:DisplayObject = !!this.method_318?this.method_318:this.parent;
         if(!_loc2_)
         {
         ...
         do
         {
            ...
            {
               if(UIComponent(_loc5_).method_318)
               {
                  _loc5_ = UIComponent(_loc5_).method_318;
               }
               else
               {
      ...
      mx_internal function get method_805() : flash.geom.Transform
      {
