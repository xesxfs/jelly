package mx.core
{
   ...
   public class AdvancedLayoutFeatures implements IAssetLayoutFeatures
   {
      ...
      private static const ZERO_REPLACEMENT_IN_3D:Number = 1.0e-14;
      ...
      public function get computedMatrix() : Matrix
      {
         ...
         {
            _loc4_ = _loc4_ * -1;
            _loc7_ = _loc7_ + this.layoutWidth;
         }
         if(this.postLayoutTransformOffsets)
         {
            _loc4_ = _loc4_ * this.postLayoutTransformOffsets.scaleX;
            _loc5_ = _loc5_ * this.postLayoutTransformOffsets.scaleY;
            _loc6_ = _loc6_ + this.postLayoutTransformOffsets.rotationZ;
            _loc7_ = _loc7_ + this.postLayoutTransformOffsets.x;
            _loc8_ = _loc8_ + this.postLayoutTransformOffsets.y;
         }
      ...
      public function get computedMatrix3D() : Matrix3D
      {
         ...
         {
            _loc5_ = _loc5_ * -1;
            _loc11_ = _loc11_ + this.layoutWidth;
         }
         if(this.postLayoutTransformOffsets)
         {
            _loc5_ = _loc5_ * this.postLayoutTransformOffsets.scaleX;
            _loc6_ = _loc6_ * this.postLayoutTransformOffsets.scaleY;
            _loc7_ = _loc7_ * this.postLayoutTransformOffsets.scaleZ;
            _loc8_ = _loc8_ + this.postLayoutTransformOffsets.rotationX;
            _loc9_ = _loc9_ + this.postLayoutTransformOffsets.rotationY;
            _loc10_ = _loc10_ + this.postLayoutTransformOffsets.rotationZ;
            _loc11_ = _loc11_ + this.postLayoutTransformOffsets.x;
            _loc12_ = _loc12_ + this.postLayoutTransformOffsets.y;
            _loc13_ = _loc13_ + this.postLayoutTransformOffsets.z;
         }
      ...
      public function transformPointToParent(param1:Boolean, param2:Vector3D, param3:Vector3D, param4:Vector3D) : void
      {
         ...
         else
         {
            ...
            if(param4 != null)
            {
               _loc7_.x = _loc7_.x / this.stretchX;
               _loc7_.y = _loc7_.y / this.stretchY;
      ...
      private function completeTransformCenterAdjustment(param1:Boolean, param2:Vector3D, param3:Vector3D, param4:Vector3D) : void
      {
         ...
         if(this.is3D || param1)
         {
            ...
            if(param4 != null && this._postLayoutTransformOffsets != null)
            {
               ...
               _loc6_.x = _loc6_.x / this.stretchX;
               _loc6_.y = _loc6_.y / this.stretchY;
               _loc7_ = transformVector(this.computedMatrix3D,_loc6_);
               if(_loc7_.equals(param4) == false)
               {
                  this.postLayoutTransformOffsets.x = this.postLayoutTransformOffsets.x + (param4.x - _loc7_.x);
                  this.postLayoutTransformOffsets.y = this.postLayoutTransformOffsets.y + (param4.y - _loc7_.y);
                  this.postLayoutTransformOffsets.z = this.postLayoutTransformOffsets.z + (param4.z - _loc7_.z);
                  this.invalidate();
               }
            }
         }
         else
         {
            ...
            if(param4 != null && this._postLayoutTransformOffsets != null)
            {
               _loc8_.x = _loc8_.x / this.stretchX;
               _loc8_.y = _loc8_.y / this.stretchY;
               _loc10_ = this.computedMatrix.transformPoint(_loc8_);
               if(_loc10_.x != param4.x || _loc10_.y != param4.y)
               {
                  this._postLayoutTransformOffsets.x = this._postLayoutTransformOffsets.x + (param4.x - _loc10_.x);
                  this._postLayoutTransformOffsets.y = this._postLayoutTransformOffsets.y + (param4.y - _loc10_.y);
                  this.invalidate();
               }
            }
         }
