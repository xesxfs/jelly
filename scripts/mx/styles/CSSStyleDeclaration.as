   ...
   public class CSSStyleDeclaration extends EventDispatcher
   {
      ...
      mx_internal function isAdvanced() : Boolean
      {
         ...
         if(this.selector != null)
         {
            ...
            {
               if(this.subject != "package_3" && this.subject != "global")
               {
                  return true;
               }
      ...
      mx_internal function addStyleToProtoChain(param1:Object, param2:DisplayObject, param3:Object = null) : Object
      {
         ...
         var var_1055:DisplayObject = param2;
         ...
         for each(style in parentStyleDeclarations)
         {
            ...
            {
               chain = style.addDefaultStyleToProtoChain(chain,var_1055,filterMap);
            }
         }
         if(this.defaultFactory != null)
         {
            chain = this.addDefaultStyleToProtoChain(chain,var_1055,filterMap);
         }
         ...
         for each(style in parentStyleDeclarations)
         {
            ...
            {
               chain = style.addFactoryAndOverrideStylesToProtoChain(chain,var_1055,filterMap);
         ...
         {
            chain = this.addFactoryAndOverrideStylesToProtoChain(chain,var_1055,filterMap);
            if(inChain != chain)
            {
      ...
      mx_internal function applyFilter(param1:Object, param2:Object, param3:Object) : Object
      {
         ...
         for(var_49 in chain)
         {
            if(filterMap[var_49] != null)
            {
               filteredChain[filterMap[var_49]] = chain[var_49];
            }
         }
         chain = filteredChain;
