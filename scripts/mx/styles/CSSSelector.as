package mx.styles
{
   ...
   public class CSSSelector
   {
      ...
      public function get specificity() : int
      {
         var _loc2_:* = null;
         var _loc1_:int = 0;
         if("package_3" != this.subject && "global" != this.subject && "" != this.subject)
         {
            _loc1_ = 1;
         }
         if(this.conditions != null)
         {
            ...
            {
               _loc1_ = _loc1_ + _loc2_.specificity;
            }
         }
         if(this.ancestor != null)
         {
            _loc1_ = _loc1_ + this.ancestor.specificity;
         }
         return _loc1_;
      }
      ...
      public function matchesStyleClient(param1:IAdvancedStyleClient) : Boolean
      {
         ...
         if(this.ancestor)
         {
            ...
            while(_loc4_ != null)
            {
               if(_loc4_.matchesCSSType(this.ancestor.subject) || "package_3" == this.ancestor.subject)
               {
         ...
         {
            if(this.subject == "package_3" || this.subject == "" || param1.matchesCSSType(this.subject))
            {
               _loc2_ = true;
            }
