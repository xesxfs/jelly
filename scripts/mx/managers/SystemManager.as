package mx.managers
{
   ...
   public class SystemManager extends MovieClip implements IChildList, IFlexDisplayObject, IFlexModuleFactory, ISystemManager
   {
      ...
      public static function getSWFRoot(param1:Object) : DisplayObject
      {
         ...
         for(_loc3_ in allSystemManagers)
         {
      ...
      mx_internal final function get method_584() : int
      {
      ...
      mx_internal final function method_910(param1:String, param2:Function, param3:Boolean = false, param4:int = 0, param5:Boolean = false) : void
      {
      ...
      mx_internal final function method_905(param1:String, param2:Function, param3:Boolean = false) : void
      {
      ...
      private function initHandler(param1:Event) : void
      {
         ...
         allSystemManagers["[object SystemManager]"] = this.loaderInfo.url;
      ...
      {
         var var_564:Number = NaN;
         var var_324:Number = NaN;
         ...
         try
         {
            var_564 = loaderInfo.width;
            var_324 = loaderInfo.height;
         }
         catch(error:Error)
         {
            if(!_screen)
         ...
         var x:Number = (var_564 - w) / 2;
         var y:Number = (var_324 - h) / 2;
      ...
      public function getVisibleApplicationRect(param1:Rectangle = null, param2:Boolean = false) : Rectangle
      {
         ...
         if(!param1)
         {
            ...
            param1.height = param1.height - _loc7_.height;
         }
         if(!this.topLevel)
         {
