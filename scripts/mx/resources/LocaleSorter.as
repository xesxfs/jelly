package mx.resources
{
   ...
   public class LocaleSorter
   {
      ...
      public static function sortLocalesByPreference(param1:Array, param2:Array, param3:String = null, param4:Boolean = false) : Array
      {
         ...
         var_1158 = 0;
         while(var_1158 < locales.length)
         {
            hasLocale[locales[var_1158]] = var_1158;
            var_1158++;
         }
         var_49 = 0;
         ...
         while(var_49 < l)
         {
            plocale = LocaleID.fromString(preferenceLocales[var_49]);
            promote(preferenceLocales[var_49]);
            ...
            while(var_1158 < l)
            {
               locale = preferenceLocales[var_1158];
