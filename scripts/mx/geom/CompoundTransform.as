      ...
      private function invalidate(param1:uint, param2:Boolean) : void
      {
         switch(param1)
         {
            case INVALIDATE_FROM_PROPERTY:
               ...
               this._flags = this._flags | PROPERTIES_VALID;
               this._flags = this._flags & ~MATRIX_VALID;
               this._flags = this._flags & ~MATRIX3D_VALID;
               break;
         ...
         if(param2)
         {
            this._flags = this._flags & ~M3D_FLAGS_VALID;
         }
      }
