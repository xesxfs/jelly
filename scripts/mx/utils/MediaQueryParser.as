   ...
   public class MediaQueryParser
   {
      ...
      private function tokenizeMediaQuery(param1:String) : Array
      {
         ...
         while(_loc8_ < _loc6_)
         {
            ...
            {
               if(_loc9_ == "/" && _loc8_ < _loc6_ - 1 && param1.charAt(_loc8_ + 1) == "package_3")
               {
                  _loc5_ = true;
                  _loc8_++;
               }
               ...
               {
                  if(_loc9_ == "package_3" && _loc8_ < _loc6_ - 1 && param1.charAt(_loc8_ + 1) == "/")
                  {
                     _loc5_ = false;
                     _loc8_++;
                  }
      ...
      private function deHyphenate(param1:String) : String
      {
         ...
         while(_loc2_ > 0)
         {
            ...
            param1 = param1 + (_loc4_ + _loc3_.substr(1));
